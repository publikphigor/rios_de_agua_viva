...
export default function Footer() {
  return (
    <footer className="w-full py-5 px-[5%] mt-16 text-white bg-secondary">
      <div className="flex justify-between gap-4">
        <div className="w-1/3">
          <h2 className="mb-3 text-2xl font-semibold">Contact Us</h2>
          <p className="mb-1">234a Sheridan Ave, Perth Amboy NJ. 08861.</p>
          <a href="tel:+23412289102" className="block mb-1">
            6095158824
          </a>
          <a href="tel:+23412289102" className="block mb-3">
            6096720668
          </a>
